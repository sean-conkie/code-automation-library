...
with DAG('fixture-load',
  ...
  create_fact_fixture = BigQueryOperator(
      task_id = 'create_fact_fixture',
      use_legacy_sql = False,
      params = {
  ...
  start_pipeline >> load_fixtures >> check_fixtures >> loaded_data_to_staging >> finish_pipeline
