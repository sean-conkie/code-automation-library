...
#   )
  ...
  loaded_data_to_archive = DummyOperator(
      task_id = 'loaded_data_to_archive'
  )
  ...
  loaded_data_to_datastore = DummyOperator(
      task_id = 'loaded_data_to_datastore'
  )
  ...
  loaded_data_to_datawarehouse = DummyOperator(
      task_id = 'loaded_data_to_datawarehouse'
  )
  ...
  start_pipeline >> load_teams >> check_teams >> loaded_data_to_archive >> [build_cc_team] >> loaded_data_to_datastore >> build_dim_team  >> loaded_data_to_datawarehouse >> finish_pipeline
